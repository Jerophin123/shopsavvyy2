        ...
        login: async (email, password)=>{
            ...
            if (email && password) {
                const user = {
                    ...
                    email,
                    name: email.split('@')[0],
                    avatar: "https://api.dicebear.com/7.x/personas/svg?seed=".concat(email, "&backgroundColor=6366f1,8b5cf6,ec4899&backgroundType=gradientLinear")
                };
                set({
                    user,
...
_s(Navigation, "seV8TQ21MOa4TAnyyQ2QirOWPlY=", false, function() {
    return [
...
//# sourceMappingURL=src_d6081e95._.js.map