...
"[project]/src/store/orderStore.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/payment-success/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$orderStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/store/orderStore.ts [app-client] (ecmascript)");
;
...
function PaymentSuccessPage() {
    _s();
    const { items, getTotalPrice, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$cartStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])();
    ...
    const { currentOrder, addOrder, clearCurrentOrder } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$orderStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrderStore"])();
    ...
    const [hasProcessedOrder, setHasProcessedOrder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Update time every second for real-time display
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PaymentSuccessPage.useEffect": ()=>{
            const timer = setInterval({
                "PaymentSuccessPage.useEffect.timer": ()=>{
                    setCurrentTime(new Date());
                }
            }["PaymentSuccessPage.useEffect.timer"], 1000);
            return ({
                "PaymentSuccessPage.useEffect": ()=>clearInterval(timer)
            })["PaymentSuccessPage.useEffect"];
        }
    }["PaymentSuccessPage.useEffect"], []);
        ...
        "PaymentSuccessPage.useEffect": ()=>{
            ...
            if (!hasProcessedOrder) {
                if (items.length > 0) {
                    ...
                    const timer = setTimeout({
                        "PaymentSuccessPage.useEffect.timer": ()=>{
                            ...
                            const newOrder = {
                                ...
                                items: items.map({
                                    "PaymentSuccessPage.useEffect.timer": (item)=>({
                                            id: item.id,
                                            title: item.title,
                                            price: item.price,
                    ...
                    }["PaymentSuccessPage.useEffect.timer"], 1500); // 1.5 second delay
                    return ({
                        "PaymentSuccessPage.useEffect": ()=>clearTimeout(timer)
                    })["PaymentSuccessPage.useEffect"];
                    ...
                    setOrderData({
                        ...
                        items: currentOrder.items.map({
                            "PaymentSuccessPage.useEffect": (item)=>({
                                    id: item.id,
                                    name: item.title,
                                    quantity: item.quantity,
                                    price: item.price,
                    ...
                    }["PaymentSuccessPage.useEffect.timer"], 1500);
                    return ({
                        "PaymentSuccessPage.useEffect": ()=>clearTimeout(timer)
                    })["PaymentSuccessPage.useEffect"];
                }
    ...
    }["PaymentSuccessPage.useEffect"], []); // Empty dependency array to run only once
    ...
    const handleDownloadReceipt = ()=>{
        ...
        link.href = url;
        link.download = "receipt-".concat(orderData.orderNumber, ".json");
        link.click();
...
_s(PaymentSuccessPage, "wZTSYjhFQMOTvYPhIXv0NFMf9Y8=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$orderStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrderStore"]
    ];
});
...
//# sourceMappingURL=_68a1cae7._.js.map