      ...
      <section className="relative min-h-[60vh] md:min-h-[85vh] flex items-center justify-center mobile-safe hero-section">
        ...
        <div className="absolute inset-0">
          ...
          {/* Apple-Style Floating Icons */}
                      ...
                      >
            <div className="w-16 h-16 glass ios-rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/20 hover:bg-white/15 transition-all duration-300 liquid-flow">
              <ShoppingBag size={24} className="text-blue-400/90" />
            </div>
          </motion.div>
          ...
          >
            <div className="w-12 h-12 glass ios-rounded-2xl flex items-center justify-center shadow-2xl shadow-pink-500/20 hover:bg-white/15 transition-all duration-300 liquid-flow">
              <Heart size={18} className="text-pink-400/90" />
            </div>
          </motion.div>
          ...
          >
            <div className="w-18 h-18 glass ios-rounded-2xl flex items-center justify-center shadow-2xl shadow-yellow-500/20 hover:bg-white/15 transition-all duration-300 liquid-flow">
              <Star size={26} className="text-yellow-400/90" />
            </div>
          </motion.div>
          ...
          >
            <div className="w-14 h-14 glass ios-rounded-2xl flex items-center justify-center shadow-2xl shadow-purple-500/20 hover:bg-white/15 transition-all duration-300 liquid-flow">
              <Zap size={20} className="text-purple-400/90" />
            </div>
          </motion.div>
          ...
          >
            <div className="w-10 h-10 glass ios-rounded-2xl flex items-center justify-center shadow-2xl shadow-green-500/20 hover:bg-white/15 transition-all duration-300 liquid-flow">
              <Shield size={16} className="text-green-400/90" />
            </div>
          </motion.div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute top-4 right-4 z-10">
                      <div className="glass-button ios-rounded-xl px-3 py-1 flex items-center space-x-1 bg-red-500/20 border border-red-500/30">
                        {React.createElement(offerIcons[index], { size: 14, className: "text-red-400" })}
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-3">
                        <Link href={`/product/${product.id}`}>
                          <h3 className="text-xl font-bold text-white hover:text-blue-300 transition-colors cursor-pointer line-clamp-2">
                            {product.title}
                          </h3>
                        </Link>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <motion.button
                          ...
                          className="glass-button px-6 py-2 ios-rounded-xl text-white font-semibold text-sm flex items-center space-x-2 press-effect"
                        >
                          <ShoppingBag size={14} />
                          <span>Add to Cart</span>
                        </motion.button>
